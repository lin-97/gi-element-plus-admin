...
declare global {
  ...
  const listToTree: typeof import('./utils/tree').listToTree
  ...
  const normalizeMenuPaths: typeof import('./utils/menu').normalizeMenuPaths
  ...
  const treeToList: typeof import('./utils/tree').treeToList
  ...
  const useChart: typeof import('./hooks/useChart').useChart
