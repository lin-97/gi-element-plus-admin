...
declare global {
  ...
  const AppNoticeDrawer: typeof import('./components/AppNoticeDrawer/index.vue')['default']
  ...
  const GTableSetting: typeof import('./components/GTableSetting/index.vue')['default']
